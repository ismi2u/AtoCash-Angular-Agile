...
export class BusinessUnitService {
	...
	getBusinessUnitByBizTypeIdAndEmployeeId = (id: any) =>
		this.http.get(`${this.commonService.getApi()}/api/BusinessUnits/BusinessUnitsByBizTypeIdAndEmpIdForDropdown/${id}`);
