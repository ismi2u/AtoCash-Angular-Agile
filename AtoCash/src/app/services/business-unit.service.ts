...
export class BusinessUnitService {
	...
	getBusinessUnitByBizTypeIdAndEmployeeId = (data: any) =>
		this.http.post(`${this.commonService.getApi()}/api/BusinessUnits/BusinessUnitsByBizTypeIdAndEmpIdForDropdown`, data);
